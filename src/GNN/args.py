...
parser.add_argument('-da', '--dataset', default='/home/sakbarian/milgnet/NewGraph/Orig/MilGNet/dataset/B-dataset', type=str,
                    help='Set the data set for training')

parser.add_argument('-ll', '--llm_rep_path', default='/mnt/whiskey-data-1/milgnet/dataset/B-dataset/Final_SS/llm_rep_final_dataset.pkl', type=str,
                    help='LLM generated representations')

parser.add_argument('-di', '--Disease_mapper', default='/mnt/whiskey-data-1/milgnet/dataset/B-dataset/Disease_B_mapper.pkl', type=str,
                    help=' Map disease number to its name ')

parser.add_argument('-dr', '--Drug_mapper', default='/mnt/whiskey-data-1/milgnet/dataset/B-dataset/Drug_B_mapper.pkl', type=str,
                    help='Map drug number to its name')

parser.add_argument('-sp', '--saved_path', default='/mnt/whiskey-data-1/milgnet/dataset/B-dataset/B_normalize_seed2', type=str,
